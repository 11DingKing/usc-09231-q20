""" . "说明"specs/security-handler-architecture.md is the design.""" . "说明"
...
class SecurityHandler:
    """ . "说明"One RFB security type: RFC 6143 section 7.2.""" . "说明"

    SECURITY_TYPE: ClassVar[AuthTypes]

    def handle(self, client: Any) -> Generator[int, bytes, bool]:
        """ . "说明"Yield the byte counts this security type needs, each satisfied in
...
def security_result(client: Any) -> Generator[int, bytes, bool]:
    """ . "说明"RFC 6143 section 7.1.3, and the reason string 3.8 adds on failure.""" . "说明"
